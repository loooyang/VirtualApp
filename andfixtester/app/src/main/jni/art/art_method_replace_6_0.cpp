...
void replace_6_0(JNIEnv* env, jobject src, jobject dest) {
    ...
    void *temp = smeth->ptr_sized_fields_.entry_point_from_interpreter_;
    smeth->ptr_sized_fields_.entry_point_from_interpreter_ =
            dmeth->ptr_sized_fields_.entry_point_from_interpreter_;
    dmeth->ptr_sized_fields_.entry_point_from_interpreter_ = temp;

    temp = smeth->ptr_sized_fields_.entry_point_from_jni_;
    smeth->ptr_sized_fields_.entry_point_from_jni_ =
            dmeth->ptr_sized_fields_.entry_point_from_jni_;
    dmeth->ptr_sized_fields_.entry_point_from_jni_ = temp;

    temp = smeth->ptr_sized_fields_.entry_point_from_quick_compiled_code_;
    smeth->ptr_sized_fields_.entry_point_from_quick_compiled_code_ =
            dmeth->ptr_sized_fields_.entry_point_from_quick_compiled_code_;
    dmeth->ptr_sized_fields_.entry_point_from_quick_compiled_code_ = temp;
