...
//			reinterpret_cast<art::mirror::Class*>(dmeth->declaring_class_)->class_loader_; //for plugin classloader
	...
	dmeth->hotness_count_ ^= smeth->hotness_count_;
	...
	art::mirror::ArtMethod **temp = smeth->ptr_sized_fields_.dex_cache_resolved_methods_;
	smeth->ptr_sized_fields_.dex_cache_resolved_methods_ =
			dmeth->ptr_sized_fields_.dex_cache_resolved_methods_;
	dmeth->ptr_sized_fields_.dex_cache_resolved_methods_ = temp;


	void *tmp = smeth->ptr_sized_fields_.dex_cache_resolved_types_;
	smeth->ptr_sized_fields_.dex_cache_resolved_types_ =
			dmeth->ptr_sized_fields_.dex_cache_resolved_types_;
	dmeth->ptr_sized_fields_.dex_cache_resolved_types_ = tmp;
